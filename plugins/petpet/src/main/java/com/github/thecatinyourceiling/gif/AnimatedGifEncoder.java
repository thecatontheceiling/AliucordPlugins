package com.github.thecatinyourceiling.gif;
...
public class AnimatedGifEncoder {
     ...
     * Lyssa: It seems like this code was mistakenly drawing the blank `temp` bitmap onto itself.
     * Updated it to draw `source` (image) on it instead.
     * Also have to get width and height again before calling getPixels.
     */
